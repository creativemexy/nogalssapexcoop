...
interface AllocationStats {
  ...
  averageCooperativeAllocation: number;
}
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-gray-600">Track your organization's 20% allocation from member registration fees</p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{formatCurrency(allocationStats.cooperativeAllocation)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{formatCurrency(allocationStats.averageCooperativeAllocation)}</p>
            </div>
          </div>
        </div>
      </div>
              ...
              {allocationStats.recentTransactions.map((transaction) => (
                <tr key={transaction.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-green-600">
                    {formatCurrency(transaction.cooperativeAllocation)}
                  </td>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {allocationStats.monthlyBreakdown.map((month, index) => (
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-green-600">
                    {formatCurrency(month.cooperativeAllocation)}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
